    ...
    <ChartContext.Provider value={{ config }}>
      <div
        ...
        className={cn(
          ...
          "[&_.recharts-cartesian-grid-horizontal line]:stroke-[hsl(var(--ring)/0.15)]",
          "[&_.recharts-cartesian-grid-vertical line]:stroke-[hsl(var(--ring)/0.08)]",
          "[&_.recharts-cartesian-axis-line]:stroke-transparent",
          "[&_.recharts-tooltip-cursor]:!transition-all [&_.recharts-tooltip-cursor]:!duration-300",
          className
        )}
        {...props}
      >
